"""
Django settings for jerseyfans project.
...
SECRET_KEY = '5)zv+ypo$@4kua4knrv@l#s$z14!1nyc23-fw8p$$j-i%eebg('
...
WSGI_APPLICATION = 'jerseyfans.wsgi.application'
